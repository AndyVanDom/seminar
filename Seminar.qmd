...
::: {.fragment fragment-index=1 .fade-in-then-out .slow1 style="position: absolute; top: 265px; left: 120px; width: 750px;"}
![](img/arhl-dem/causal.png)
:::

::: {.fragment fragment-index=2 .fade-in-then-out .slow1 style="position: absolute; top: 175px; left: 275px; width: 400px;"}
![](img/arhl-dem/mediate.png)
:::

::: {data-id="causal-sml" style="position: absolute; top: -2020px; left: 975px; width: 200px; opacity: 0.5;"}
![](img/arhl-dem/causal.png)
:::

## Can Hearing Loss [cause]{style="color: var(--lab-blue);"} Dementia? {auto-animate="true"}

::: {data-id="causal-sml" style="position: absolute; top: -20px; left: 975px; width: 200px; opacity: 0.5;"}
![](img/arhl-dem/causal.png)
:::
...
::: {data-id="mediate" style="position: absolute; top: -100%; left: 100%; width: 125px; opacity: 0.5;"}
![](img/arhl-dem/mediate.png)
:::
...
::: {data-id="mediate" style="position: absolute; top: -4%; left: 100%; width: 125px; opacity: 0.5;"}
![](img/arhl-dem/mediate.png)
:::

::: {.fragment fragment-index=1 .fade-in style="position: absolute; top: 100px; left: 480px; width: 525px;"}
::: {.fragment fragment-index=5 .fade-out}
![](img/mtag/common.png)
:::
:::

::: {.fragment fragment-index=5 .fade-in style="position: absolute; top: 150px; left: 460px; width: 500px; color: var(--lab-yellow); text-align: center;"}
...
## [Evidence for a [Genetic Correlation]{style="color: var(--lab-blue);"} between ARHL and Dementia]{style="font-size: 30pt;"}
...
::: {.fragment fragment-index=4 .fade-in .overview-text-box style="color: white; background: gray; position: absolute; top: 150px; left: 500px; width: 500px; font-size: 50pt; padding-top: 0.1em;" .nonincremental}
ARHGEF28
...
## [What [data]{style="color: var(--lab-blue);"} are we using?]{style="font-size: 40pt;"} {data-name="Data"}
...
::: {.fragment fragment-index=6 .fade-in style="position: absolute; left: 250px; top: 100px; width: 600px; height: auto; opacity: 0.4"}
![](img/aim1/clsa_desc.jpg)
:::

::: {.fragment fragment-index=6 .fade-in style="position: absolute; left: 32%; top: 37%; width: 600px; height: auto; color: red; font-size: 50pt;"}
2686 variables!
:::
...
::: {.fragment fragment-index=1 .fade-in-then-out style="width: 300px;"}
Memory (REY)
...
::: {.fragment fragment-index=3 .slide-in-from-left-then-right style="position: absolute; left: 400px; top: 60px; width: 585px; height: auto;"}
![](img/aim1/cii_by_age.png)
:::

::: {.fragment fragment-index=4 .slide-in-from-left-then-right style="position: absolute; left: 400px; top: 60px; width: 585px; height: auto;"}
![](img/aim1/cii_by_sex.png)
:::

::: {.fragment fragment-index=5 .slide-in-from-left-then-right style="position: absolute; left: 400px; top: 60px; width: 585px; height: auto;"}
![](img/aim1/cii_by_ed.png)
:::

::: {.fragment fragment-index=6 .slide-in-from-right .slow3 style="position: absolute; left: 50%; top: 10%; width: 350px; height: auto;"}
![](img/dem/dem_lancet.jpg)
:::

:::: {style="position: absolute; top: 17%;"}

::: {.fragment fragment-index=6 .slide-in-from-bottom .slow1}
Vision Loss
:::

::: {.fragment fragment-index=6 .slide-in-from-bottom}
Hypertension
:::
...
::: {.fragment fragment-index=6 .slide-in-from-bottom .slow2}
Social Activity
:::
...
[Sensory Hearing Loss]{style="opacity: 0.5;"}
...
[Metabolic Hearing Loss]{data-id="mhl" style="opacity: 0.5;"}

- [Strong correlation with age]{style="font-size: 25pt; opacity: 0.5;"}

Sensory Hearing Loss

- [Not strongly correlated with age]{style="font-size: 20pt;"}
...
- Identify Covariates
- Run GWAS ([PLINK]{style="color:gray;"})
- QC ([LDSC]{style="color:gray;"})
:::
...
::: {.overview-text-box data-id="future" style="background: #385E9D; color: white; position: absolute; top: 13%; left: 0%; width: 1100px; padding: 0.5em; z-index: 1;"}
...
::: {.overview-text-box data-id="future" style="background: #f2ce82; position: absolute; top: 13%; left: 0%; width: 1100px; padding: 0.5em; z-index: 1;"}
...
![](img/future/df.png){style="width: 250px;"}
...
::: {.overview-text-box data-id="future" style="background: #ff8989; position: absolute; top: 13%; left: 0%; width: 1100px; padding: 0.5em; z-index: 1;"}
...
::: {.overview-text-box data-id="future" style="background: gray; position: absolute; top: 13%; left: 0%; width: 1100px; padding: 0.5em; z-index: 1;"}
...
::: {style="position: absolute; top: 2%; left: 5%; width: 1000px;"}
![](img/ack.png)
:::
